...
/// Opens a xenomorphic:// URL within the application.
#[derive(Clone, PartialEq, Deserialize, JsonSchema, Action)]
#[action(namespace = zed)]
#[serde(deny_unknown_fields)]
...
actions!(
    ...
    [
        ...
        #[action(deprecated_aliases = ["xenomorphic_actions::OpenSettingsEditor"])]
        OpenSettings,
        /// Opens the settings JSON file.
        #[action(deprecated_aliases = ["xenomorphic_actions::OpenSettings"])]
        OpenSettingsFile,
        /// Opens project-specific settings.
        #[action(deprecated_aliases = ["xenomorphic_actions::OpenProjectSettings"])]
        OpenProjectSettings,
        /// Opens the default keymap file.
        OpenDefaultKeymap,
        /// Opens the user keymap file.
        #[action(deprecated_aliases = ["xenomorphic_actions::OpenKeymap"])]
        OpenKeymapFile,
        /// Opens the keymap editor.
        #[action(deprecated_aliases = ["xenomorphic_actions::OpenKeymapEditor"])]
        OpenKeymap,
        ...
        Quit,
        /// Shows information about Xenomorphic.
        About,
...
pub struct CreateWorktree {
    /// When this is None, Xenomorphic will randomly generate a worktree name.
...
pub mod feedback {
    ...
    actions!(
        feedback,
        [
            /// Opens email client to send feedback to Xenomorphic support.
            EmailZed,
...
pub struct Rerun {
    ...
    /// If it is not, environment variables such as XENOMORPHIC_COLUMN, XENOMORPHIC_FILE are gonna be the same as in the last execution of a task
