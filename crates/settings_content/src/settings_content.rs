...
pub struct SettingsContent {
    ...
    /// Configuration of audio in Xenomorphic.
    ...
    /// This base keymap settings adjusts the default keybindings in Xenomorphic to be similar
    /// to other common code editors. By default, Xenomorphic's keymap closely follows VSCode's
    ...
    // Settings related to calls in Xenomorphic
    pub calls: Option<CallSettingsContent>,

    /// Settings for the which-key popup.
    pub which_key: Option<WhichKeySettingsContent>,

    /// Settings related to Vim mode in Xenomorphic.
...
/// diagnostic data about a running Xenomorphic instance.
#[with_fallible_options]
...
pub enum ProfileBase {
    ...
    #[default]
    User,
    /// Apply profile settings on top of Xenomorphic's default settings, ignoring user customizations.
    Default,
}
...
pub struct SettingsProfile {
    ...
    /// - `default`: Apply on top of Xenomorphic's default settings, ignoring user customizations
    #[serde(default)]
...
pub struct TelemetrySettingsContent {
    ...
    /// Send anonymized usage data like what languages you're using Xenomorphic with.
    ///
    /// Default: true
...
pub struct DebuggerSettingsContent {
    ...
    /// Whether the breakpoints should be reused across Xenomorphic sessions.
    ///
    /// Default: true
    ...
    /// Whether to log messages between active debug adapters and Xenomorphic
    ///
    /// Default: true
...
/// Configuration of voice calls in Xenomorphic.
#[with_fallible_options]
#[derive(Clone, PartialEq, Default, Serialize, Deserialize, JsonSchema, MergeFrom, Debug)]
...
pub struct FileFinderSettingsContent {
    ...
    /// Only the file Xenomorphic had indexed will be used, not necessary all the gitignored files.
    ///
    /// Default: Smart
...
pub enum IncludeIgnoredContent {
    ...
    All,
    /// Use only the files Xenomorphic had indexed
    Indexed,
...
pub struct SshConnection {
    ...
    // By default Xenomorphic will download the binary to the host directly.
    // If this is set to true, Xenomorphic will download the binary to your local machine,
