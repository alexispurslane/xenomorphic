...
AppPublisher=Xenomorphic Contributors
AppPublisherURL=https://xenomorphic.dev/
AppSupportURL=https://xenomorphic.dev/
AppUpdatesURL=https://xenomorphic.dev/
...
; URI Scheme
Root: HKCU; Subkey: "Software\Classes\xenomorphic"; ValueType: "string"; ValueData: "URL:xenomorphic Protocol"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\Classes\xenomorphic"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCU; Subkey: "Software\Classes\xenomorphic\DefaultIcon"; ValueType: "string"; ValueData: "{app}\Xenomorphic.exe,1"
Root: HKCU; Subkey: "Software\Classes\xenomorphic\shell\open\command"; ValueType: "string"; ValueData: """{app}\Xenomorphic.exe"" ""%1"""
...
begin
  if WizardIsTaskSelected('addcontextmenufiles') then begin
    ShellExec('', 'powershell.exe', '-Command ' + AddQuotes('Add-AppxPackage -Path ''' + ExpandConstant('{app}\appx\xenomorphic_explorer_command_injector.appx') + ''' -ExternalLocation ''' + ExpandConstant('{app}\appx') + ''''), '', SW_HIDE, ewWaitUntilTerminated, AddAppxPackageResultCode);
