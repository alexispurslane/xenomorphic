...
use xenomorphic_actions::{debug_panel, dev};

pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    use xenomorphic_actions::Quit;

    let mut view_items = vec![
        MenuItem::action(
            "Zoom In",
            xenomorphic_actions::IncreaseBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Zoom Out",
            xenomorphic_actions::DecreaseBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Reset Zoom",
            xenomorphic_actions::ResetBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Reset All Zoom",
            xenomorphic_actions::ResetAllZoom { persist: false },
        ),
        MenuItem::separator(),
        ...
        MenuItem::separator(),
        MenuItem::action("Project Panel", xenomorphic_actions::project_panel::ToggleFocus),
    ...
    vec![
        Menu {
            ...
            disabled: false,
            items: vec![
                MenuItem::action("About Xenomorphic", xenomorphic_actions::About),
                MenuItem::action("Check for Updates", auto_update::Check),
                MenuItem::separator(),
                MenuItem::submenu(Menu::new("Settings").items([
                    MenuItem::action("Open Settings", xenomorphic_actions::OpenSettings),
                    MenuItem::action("Open Settings File", super::OpenSettingsFile),
                    MenuItem::action("Open Project Settings", xenomorphic_actions::OpenProjectSettings),
                    MenuItem::action("Open Project Settings File", super::OpenProjectSettingsFile),
                    MenuItem::action("Open Default Settings", super::OpenDefaultSettings),
                    MenuItem::separator(),
                    MenuItem::action("Open Keymap", xenomorphic_actions::OpenKeymap),
                    MenuItem::action("Open Keymap File", xenomorphic_actions::OpenKeymapFile),
                    MenuItem::action("Open Default Key Bindings", xenomorphic_actions::OpenDefaultKeymap),
                    MenuItem::separator(),
                    MenuItem::action(
                        "Select Theme...",
                        xenomorphic_actions::theme_selector::Toggle::default(),
                    ),
                    MenuItem::action(
                        "Select Icon Theme...",
                        xenomorphic_actions::icon_theme_selector::Toggle::default(),
                    ),
                ])),
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                ...
                MenuItem::separator(),
                MenuItem::action("Extensions", xenomorphic_actions::Extensions::default()),
                MenuItem::action("Install CLI", install_cli::InstallCliBinary),
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Xenomorphic", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit Xenomorphic", Quit),
            ],
        },
        Menu {
            name: "File".into(),
            ...
            items: vec![
                ...
                MenuItem::action(
                    "Open Remote...",
                    xenomorphic_actions::OpenRemote {
                        create_new_window: false,
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::separator(),
                MenuItem::action("Command Palette...", xenomorphic_actions::command_palette::Toggle),
                MenuItem::separator(),
                MenuItem::action("Go to File...", workspace::ToggleFileFinder::default()),
                // MenuItem::action("Go to Symbol in Project", project_symbols::Toggle),
                MenuItem::action(
                    "Go to Symbol in Editor...",
                    xenomorphic_actions::outline::ToggleOutline,
                ),
        ...
        Menu {
            ...
            items: vec![
                MenuItem::action(
                    "Spawn Task",
                    xenomorphic_actions::Spawn::ViaModal {
                        reveal_target: None,
                    },
                ),
                MenuItem::action("Start Debugger", debugger_ui::Start),
                MenuItem::separator(),
                MenuItem::action("Edit tasks.json...", crate::xenomorphic_app::OpenProjectTasks),
                MenuItem::action("Edit debug.json...", xenomorphic_actions::OpenProjectDebugTasks),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action("View Telemetry", xenomorphic_actions::OpenTelemetryLog),
                MenuItem::action("View Dependency Licenses", xenomorphic_actions::OpenLicenses),
                MenuItem::action("Show Welcome", onboarding::ShowWelcome),
                MenuItem::separator(),
                MenuItem::action("File Bug Report...", xenomorphic_actions::feedback::FileBugReport),
                MenuItem::action("Request Feature...", xenomorphic_actions::feedback::RequestFeature),
                MenuItem::action("Email Us...", xenomorphic_actions::feedback::EmailZed),
                MenuItem::separator(),
                MenuItem::action(
                    "Documentation",
                    super::OpenBrowser {
                ...
                MenuItem::action("Xenomorphic Repository", feedback::OpenZedRepo),
                MenuItem::action(
                    "Xenomorphic Twitter",
                    super::OpenBrowser {
