...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Xenomorphic Dev Instance Running",
        ReleaseChannel::Nightly => "Xenomorphic Nightly Instance Running",
        ReleaseChannel::Preview => "Xenomorphic Preview Instance Running",
        ReleaseChannel::Stable => "Xenomorphic Stable Instance Running",
    }
}
