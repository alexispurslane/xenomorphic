...
impl MoveToApplicationsRequest {
    ...
    async fn prompt(
        ...
        let response = cx
            .prompt(
                PromptLevel::Info,
                "Move Xenomorphic to Applications?",
                Some(
                    "Xenomorphic is running from a temporary location. Move it to Applications to finish installing it.",
                ),
                &[
                    PromptButton::ok("Yes"),
            ...
            0 => {
                workspace
                    .update_in(cx, |workspace, window, cx| {
                        workspace
                            .toggle_modal(window, cx, |_window, cx| InstallingXenomorphicModal::new(cx));
                    })
                    .ok();
                if let Err(error) = move_to_applications(&self.app_path, cx).await {
                    workspace
                        .update_in(cx, |workspace, _window, cx| {
                            if let Some(modal) = workspace.active_modal::<InstallingXenomorphicModal>(cx) {
                    ...
                    cx.prompt(
                        ...
                        "Failed to move Xenomorphic to Applications",
...
pub struct InstallingXenomorphicModal {
    focus_handle: FocusHandle,
    finished: bool,
}

impl InstallingXenomorphicModal {
...
impl EventEmitter<DismissEvent> for InstallingXenomorphicModal {}

impl ModalView for InstallingXenomorphicModal {
...
impl Focusable for InstallingXenomorphicModal {
    fn focus_handle(&self, _cx: &App) -> FocusHandle {
        self.focus_handle.clone()
    }
}

impl Render for InstallingXenomorphicModal {
        ...
        v_flex()
            ...
            .child(
                div()
                    ...
                    .child(Label::new("Installing Xenomorphic…")),
            )
            .child(
                h_flex()
                    .w_full()
                    ...
                    .child(
                        v_flex()
                            .gap_1()
                            .child(Label::new("Moving Xenomorphic to Applications"))
                            .child(
                                Label::new("Xenomorphic will reopen when installation is complete.")
