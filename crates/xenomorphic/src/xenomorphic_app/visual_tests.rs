...
//! Visual testing infrastructure for Xenomorphic.
//!
//! This module provides utilities for visual regression testing of Xenomorphic's UI.
//! It allows capturing screenshots of the real Xenomorphic application window and comparing
...
/// Initialize a visual test context with all necessary Xenomorphic subsystems.
...
mod tests {
    ...
    /// This test captures a screenshot of an empty Xenomorphic workspace.
    ///
