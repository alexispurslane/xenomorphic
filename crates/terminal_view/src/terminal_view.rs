...
use xenomorphic_actions::{agent::AddSelectionToThread, assistant::InlineAssist};
...
fn terminal_rerun_override(task: &TaskId) -> xenomorphic_actions::Rerun {
    xenomorphic_actions::Rerun {
