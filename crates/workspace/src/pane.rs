...
impl Pane {
    ...
    pub fn close_items(
        ...
        items_to_close.sort_by_key(|item| {
            ...
            // This will cause Xenomorphic to expand the content of the currently active item
            //
                        ...
                        if let Some(entry) = single_entry_to_resolve {
                            ...
                            menu = menu
                                ...
                                .when_some(entry_abs_path, |menu, abs_path| {
                                    menu.entry(
                                        "Copy Path",
                                        Some(Box::new(xenomorphic_actions::workspace::CopyPath)),
                                ...
                                .when_some(relative_path, |menu, relative_path| {
                                    menu.entry(
                                        "Copy Relative Path",
                                        Some(Box::new(xenomorphic_actions::workspace::CopyRelativePath)),
                                ...
                                .when(is_local, |menu| {
                                    menu.when_some(reveal_path, |menu, reveal_path| {
                                        menu.separator().entry(
                                            ...
                                            Some(Box::new(
                                                xenomorphic_actions::editor::RevealInFileManager,
                                            )),
