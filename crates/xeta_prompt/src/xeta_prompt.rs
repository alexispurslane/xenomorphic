...
impl std::fmt::Display for XetaFormat {
...
impl XetaFormat {
    pub fn parse(format_name: &str) -> Result<Self> {
        ...
        for variant in XetaFormat::iter() {
            if <&'static str>::from(&variant).to_lowercase() == lower {
                return Ok(variant);
            }
        }

        let mut results = XetaFormat::iter().filter(|version| {
...
pub fn prompt_input_contains_special_tokens(input: &XetaPromptInput, format: XetaFormat) -> bool {
...
pub fn format_xeta_prompt(input: &XetaPromptInput, format: XetaFormat) -> Option<String> {
    let max_prompt_tokens = match format {
        XetaFormat::V0112MiddleAtEnd
        | XetaFormat::V0113Ordered
        | XetaFormat::V0114180EditableRegion
        | XetaFormat::V0120GitMergeMarkers
        | XetaFormat::V0131GitMergeMarkersPrefix
        | XetaFormat::V0211Prefill
        | XetaFormat::V0211SeedCoder
        | XetaFormat::v0226Hashline
        | XetaFormat::V0304VariableEdit
        | XetaFormat::V0304SeedNoEdits
        | XetaFormat::V0306SeedMultiRegions
        | XetaFormat::V0316SeedMultiRegions
        | XetaFormat::V0317SeedMultiRegions
        | XetaFormat::V0331SeedCoderModelPy
        | XetaFormat::V0318SeedMultiRegions => 4096,
        XetaFormat::V0420Diagnostics => 8192,
        XetaFormat::V0327SingleFile => 16384,
    };

    format_prompt_with_budget_for_format(input, format, max_prompt_tokens)
}

pub fn special_tokens_for_format(format: XetaFormat) -> &'static [&'static str] {
    match format {
        XetaFormat::V0112MiddleAtEnd => v0112_middle_at_end::special_tokens(),
        XetaFormat::V0113Ordered => v0113_ordered::special_tokens(),
        XetaFormat::V0114180EditableRegion => v0114180_editable_region::special_tokens(),
        XetaFormat::V0120GitMergeMarkers => v0120_git_merge_markers::special_tokens(),
        XetaFormat::V0131GitMergeMarkersPrefix => v0131_git_merge_markers_prefix::special_tokens(),
        XetaFormat::V0211Prefill => v0211_prefill::special_tokens(),
        XetaFormat::V0211SeedCoder | XetaFormat::V0331SeedCoderModelPy => {
            seed_coder::special_tokens()
        }
        XetaFormat::v0226Hashline => hashline::special_tokens(),
        XetaFormat::V0304VariableEdit => v0304_variable_edit::special_tokens(),
        XetaFormat::V0304SeedNoEdits => seed_coder::special_tokens(),
        XetaFormat::V0316SeedMultiRegions => {
            static TOKENS: &[&str] = &[
        ...
        XetaFormat::V0318SeedMultiRegions | XetaFormat::V0420Diagnostics => {
            static TOKENS: &[&str] = &[
                seed_coder::FIM_SUFFIX,
                seed_coder::FIM_PREFIX,
                seed_coder::FIM_MIDDLE,
...
pub fn token_limits_for_format(format: XetaFormat) -> (usize, usize) {
    match format {
        XetaFormat::V0112MiddleAtEnd | XetaFormat::V0113Ordered => (150, 350),
        XetaFormat::V0114180EditableRegion => (180, 350),
        XetaFormat::V0120GitMergeMarkers
        | XetaFormat::V0131GitMergeMarkersPrefix
        | XetaFormat::V0211Prefill
        | XetaFormat::V0211SeedCoder
        ...
        | XetaFormat::V0306SeedMultiRegions
        | XetaFormat::V0316SeedMultiRegions
        | XetaFormat::V0318SeedMultiRegions
        | XetaFormat::V0420Diagnostics
        | XetaFormat::V0317SeedMultiRegions
        | XetaFormat::V0327SingleFile
        | XetaFormat::V0304SeedNoEdits => (350, 150),

        XetaFormat::V0304VariableEdit => (1024, 0),
    }
}

pub fn stop_tokens_for_format(format: XetaFormat) -> &'static [&'static str] {
    match format {
        XetaFormat::v0226Hashline => &[hashline::NO_EDITS_COMMAND_MARKER],
        XetaFormat::V0112MiddleAtEnd
        | XetaFormat::V0113Ordered
        | XetaFormat::V0114180EditableRegion
        | XetaFormat::V0120GitMergeMarkers
        ...
        | XetaFormat::V0306SeedMultiRegions
        | XetaFormat::V0304SeedNoEdits => &[],
        XetaFormat::V0316SeedMultiRegions => &[multi_region::V0316_END_MARKER],
        XetaFormat::V0318SeedMultiRegions | XetaFormat::V0420Diagnostics => {
            &[multi_region::V0318_END_MARKER]
        }
        XetaFormat::V0317SeedMultiRegions => &[multi_region::V0317_END_MARKER],
        XetaFormat::V0327SingleFile => &[multi_region::V0327_END_MARKER],
    }
}
...
pub fn excerpt_ranges_for_format(
    ...
    match format {
        XetaFormat::V0112MiddleAtEnd | XetaFormat::V0113Ordered => (
...
pub fn write_cursor_excerpt_section_for_format(
    ...
    match format {
        XetaFormat::V0112MiddleAtEnd => v0112_middle_at_end::write_cursor_excerpt_section(
            prompt,
            path,
            context,
            editable_range,
        ...
        XetaFormat::V0113Ordered | XetaFormat::V0114180EditableRegion => {
        ...
        XetaFormat::V0120GitMergeMarkers => v0120_git_merge_markers::write_cursor_excerpt_section(
            prompt,
            path,
            context,
            editable_range,
        ...
        XetaFormat::V0131GitMergeMarkersPrefix | XetaFormat::V0211Prefill => {
        ...
        XetaFormat::V0211SeedCoder
        | XetaFormat::V0331SeedCoderModelPy
        | XetaFormat::V0304SeedNoEdits => seed_coder::write_cursor_excerpt_section(
            prompt,
            path,
            context,
            editable_range,
        ...
        XetaFormat::v0226Hashline => hashline::write_cursor_excerpt_section(
            prompt,
            path,
            context,
            editable_range,
...
fn assemble_single_file_fim_prompt(
    ...
    let edit_history_section = format_edit_history_within_budget(
        ...
        "edit_history",
        budget_after_cursor,
        max_edit_event_count_for_format(&XetaFormat::V0327SingleFile),
    );
    ...
    let prompt = match format {
        ...
        | XetaFormat::V0420Diagnostics => {
            ...
            seed_coder::assemble_fim_prompt(
                ...
                &input.events,
                related_files,
                if format == XetaFormat::V0420Diagnostics {
...
pub fn max_edit_event_count_for_format(format: &XetaFormat) -> usize {
    match format {
        XetaFormat::V0112MiddleAtEnd
        | XetaFormat::V0113Ordered
        | XetaFormat::V0114180EditableRegion
...
pub fn get_prefill_for_format(
    ...
    match format {
        XetaFormat::V0211Prefill => v0211_prefill::get_prefill(context, editable_range),
        XetaFormat::V0112MiddleAtEnd
        | XetaFormat::V0113Ordered
        | XetaFormat::V0114180EditableRegion
        | XetaFormat::V0120GitMergeMarkers
        ...
        | XetaFormat::V0331SeedCoderModelPy
        | XetaFormat::v0226Hashline
        | XetaFormat::V0304VariableEdit => String::new(),
        XetaFormat::V0304SeedNoEdits
        | XetaFormat::V0306SeedMultiRegions
        | XetaFormat::V0316SeedMultiRegions
        | XetaFormat::V0318SeedMultiRegions
        | XetaFormat::V0317SeedMultiRegions
        | XetaFormat::V0420Diagnostics
        | XetaFormat::V0327SingleFile => String::new(),
    }
}

pub fn output_end_marker_for_format(format: XetaFormat) -> Option<&'static str> {
    match format {
        XetaFormat::V0120GitMergeMarkers => Some(v0120_git_merge_markers::END_MARKER),
        XetaFormat::V0131GitMergeMarkersPrefix => Some(v0131_git_merge_markers_prefix::END_MARKER),
        XetaFormat::V0211Prefill => Some(v0131_git_merge_markers_prefix::END_MARKER),
        XetaFormat::V0211SeedCoder
        | XetaFormat::V0331SeedCoderModelPy
        | XetaFormat::V0304SeedNoEdits
        | XetaFormat::V0306SeedMultiRegions => Some(seed_coder::END_MARKER),
        XetaFormat::V0316SeedMultiRegions => Some(multi_region::V0316_END_MARKER),
        XetaFormat::V0318SeedMultiRegions => Some(multi_region::V0318_END_MARKER),
        XetaFormat::V0420Diagnostics => Some(multi_region::V0318_END_MARKER),
        XetaFormat::V0317SeedMultiRegions => Some(multi_region::V0317_END_MARKER),
        XetaFormat::V0327SingleFile => Some(multi_region::V0327_END_MARKER),

        XetaFormat::V0112MiddleAtEnd
        | XetaFormat::V0113Ordered
        | XetaFormat::V0114180EditableRegion
        | XetaFormat::v0226Hashline
        | XetaFormat::V0304VariableEdit => None,
    }
}
...
pub fn encode_patch_as_output_for_format(
    ...
    match format {
        ...
        XetaFormat::V0304VariableEdit => v0304_variable_edit::patch_to_variable_edit_output(
            old_editable_region,
            patch,
            cursor_offset,
        )
        .map(Some),
        XetaFormat::V0304SeedNoEdits | XetaFormat::V0306SeedMultiRegions => {
...
/// Given a `XetaPromptInput`, a format, and a patch (with cursor already
...
/// Parse model output for the given xeta format
pub fn parse_xeta2_model_output(
    output: &str,
    format: XetaFormat,
    ...
    let (range_in_context, output) = match format {
        ...
        XetaFormat::V0304VariableEdit => v0304_variable_edit::apply_variable_edit(context, output)?,
        XetaFormat::V0304SeedNoEdits => (
            editable_range_in_context,
...
pub fn parse_xeta2_model_output_as_patch(
    output: &str,
    format: XetaFormat,
    prompt_inputs: &XetaPromptInput,
) -> Result<String> {
    let parsed = parse_xeta2_model_output(output, format, prompt_inputs)?;
...
pub fn resolve_cursor_region(
    ...
    let (editable_range, context_range) = if format == XetaFormat::V0327SingleFile {
...
pub fn get_prefill(input: &XetaPromptInput, format: XetaFormat) -> String {
    let (context, editable_range, _, _) = resolve_cursor_region(input, format);
...
pub mod seed_coder {
    ...
    pub fn assemble_fim_prompt(
        ...
        let edit_history_section = super::format_edit_history_within_budget(
            ...
            "edit_history",
            budget_after_cursor,
            max_edit_event_count_for_format(&XetaFormat::V0211SeedCoder),
        );
        let edit_history_tokens = estimate_tokens(edit_history_section.len() + "\n".len());
...
pub mod xeta1 {
    ...
    /// Formats a complete xeta1 prompt from the input events and excerpt.
    pub fn format_xeta1_prompt(input_events: &str, input_excerpt: &str) -> String {
    ...
    /// Formats a complete xeta1 prompt from a `XetaPromptInput` using the given
    /// editable and context byte-offset ranges within `cursor_excerpt`.
    pub fn format_xeta1_from_input(
        input: &XetaPromptInput,
        editable_range: Range<usize>,
        context_range: Range<usize>,
    ) -> String {
        let events = format_xeta1_events(&input.events);
        let excerpt = format_xeta1_excerpt(input, editable_range, context_range);
        format_xeta1_prompt(&events, &excerpt)
    }

    /// Formats events in xeta1 style (oldest first).
    fn format_xeta1_events(events: &[Arc<Event>]) -> String {
        let mut result = String::new();
        for event in
            events
                .iter()
        ...
        {
            let event_string = format_xeta1_event(event);
    ...
    fn format_xeta1_event(event: &Event) -> String {
        match event {
            Event::BufferChange {
                path,
                old_path,
    ...
    /// Formats the excerpt section of a xeta1 prompt using byte-offset ranges
    /// within `cursor_excerpt`.
    fn format_xeta1_excerpt(
        input: &XetaPromptInput,
        editable_range: Range<usize>,
        context_range: Range<usize>,
    ) -> String {
    ...
    /// Cleans xeta1 model output by extracting content between editable region
    /// markers and converting the xeta1 cursor marker to the universal one.
    /// Returns `None` if the output doesn't contain the expected markers.
    pub fn clean_xeta1_model_output(output: &str) -> Option<String> {
        ...
        let cursor_offset = output.find(CURSOR_MARKER).map(|xeta1_cursor_pos| {
            let text_before_cursor = output[..xeta1_cursor_pos].replace(CURSOR_MARKER, "");
            let text_before_cursor = text_before_cursor
                ...
                .unwrap_or(0);
            let offset_in_extracted = xeta1_cursor_pos
...
mod tests {
    ...
    fn format_with_budget(input: &XetaPromptInput, max_tokens: usize) -> Option<String> {
        format_prompt_with_budget_for_format(input, XetaFormat::V0114180EditableRegion, max_tokens)
    }
    ...
    #[track_caller]
    fn format_seed_coder(input: &XetaPromptInput) -> String {
        format_prompt_with_budget_for_format(input, XetaFormat::V0211SeedCoder, 10000)
            .expect("seed coder prompt formatting should succeed")
    }

    #[track_caller]
    fn format_seed_coder_with_budget(input: &XetaPromptInput, max_tokens: usize) -> String {
        format_prompt_with_budget_for_format(input, XetaFormat::V0211SeedCoder, max_tokens)
            .expect("seed coder prompt formatting should succeed")
    }
    ...
    fn test_seed_coder_alias_matches_v0211_seed_coder() {
        ...
        assert_eq!(
            format_prompt_with_budget_for_format(&input, XetaFormat::V0211SeedCoder, 10000),
            format_prompt_with_budget_for_format(&input, XetaFormat::V0331SeedCoderModelPy, 10000)
        );
        assert_eq!(
            XetaFormat::parse("V0331SeedCoderModelPy").unwrap(),
            XetaFormat::V0331SeedCoderModelPy
        );
    }
    ...
    fn test_v0420_formats_diagnostics_before_related_files() {
        ...
        let prompt =
            format_prompt_with_budget_for_format(&input, XetaFormat::V0420Diagnostics, 10000)
    ...
    fn test_v0317_formats_prompt_with_many_related_files() {
        ...
        let prompt =
            format_prompt_with_budget_for_format(&input, XetaFormat::V0317SeedMultiRegions, 4096);
    ...
    fn test_v0327_formats_single_file_prompt_without_related_files() {
        ...
        let prompt =
            format_prompt_with_budget_for_format(&input, XetaFormat::V0327SingleFile, 4096)
    ...
    fn test_v0327_resolve_cursor_region_uses_full_excerpt_context() {
        ...
        let (context, editable_range, context_range, adjusted_cursor) =
            resolve_cursor_region(&input, XetaFormat::V0327SingleFile);
    ...
    fn test_seed_coder_truncation_drops_context() {
        ...
        assert_eq!(
            format_prompt_with_budget_for_format(&input, XetaFormat::V0211SeedCoder, 24),
            None
        );
    ...
    fn test_seed_coder_truncation_prioritizes_lower_order() {
        ...
        assert_eq!(
            format_prompt_with_budget_for_format(&input, XetaFormat::V0211SeedCoder, 44),
            Some(
                indoc! {r#"
                    <[fim-suffix]>
                    <[fim-prefix]><filename>test.rs
    ...
    #[test]
    fn test_format_xeta1_from_input_basic() {
        let excerpt = "fn before() {}\nfn foo() {\n    let x = 1;\n}\nfn after() {}\n";
        let input = XetaPromptInput {
        ...
        let prompt = xeta1::format_xeta1_from_input(&input, 15..41, 0..excerpt.len());
    ...
    #[test]
    fn test_format_xeta1_from_input_no_start_of_file() {
        let excerpt = "fn foo() {\n    let x = 1;\n}\n";
        let input = XetaPromptInput {
            cursor_path: Path::new("src/main.rs").into(),
            cursor_excerpt: excerpt.into(),
        ...
        let prompt = xeta1::format_xeta1_from_input(&input, 0..28, 0..28);
    ...
    #[test]
    fn test_format_xeta1_from_input_with_sub_ranges() {
        let excerpt = "// prefix\nfn foo() {\n    let x = 1;\n}\n// suffix\n";
        ...
        let prompt = xeta1::format_xeta1_from_input(&input, editable_range, context_range);
    ...
    #[test]
    fn test_clean_xeta1_model_output_basic() {
        let output = indoc! {"
            <|editable_region_start|>
            fn main() {
                println!(\"hello\");
        ...
        let cleaned = xeta1::clean_xeta1_model_output(output).unwrap();
        assert_eq!(cleaned, "fn main() {\n    println!(\"hello\");\n}");
    }

    #[test]
    fn test_clean_xeta1_model_output_with_cursor() {
        let output = indoc! {"
            <|editable_region_start|>
            fn main() {
    ...
    #[test]
    fn test_clean_xeta1_model_output_no_markers() {
        let output = "fn main() {}\n";
        let cleaned = xeta1::clean_xeta1_model_output(output).unwrap();
        assert_eq!(cleaned, "fn main() {}\n");
    }
    ...
    #[test]
    fn test_clean_xeta1_model_output_empty_region() {
    ...
    #[test]
    fn test_parse_xeta2_model_output() {
        ...
        let output = parse_xeta2_model_output(
            "editable new\n>>>>>>> UPDATED\n",
            XetaFormat::V0131GitMergeMarkersPrefix,
            &input,
        )
    ...
    #[test]
    fn test_parse_xeta2_model_output_identity() {
        let excerpt = "aaa\nbbb\nccc\nddd\neee\n";
        ...
        let format = XetaFormat::V0131GitMergeMarkersPrefix;
        let output =
            parse_xeta2_model_output("bbb\nccc\n>>>>>>> UPDATED\n", format, &input).unwrap();

        assert_eq!(apply_edit(excerpt, &output), excerpt);
    }

    #[test]
    fn test_parse_xeta2_model_output_strips_end_marker() {
        let excerpt = "hello\nworld\n";
        let input = make_input_with_context_range(excerpt, 0..excerpt.len(), 0..excerpt.len(), 0);

        let format = XetaFormat::V0131GitMergeMarkersPrefix;
        let output1 =
            parse_xeta2_model_output("new content\n>>>>>>> UPDATED\n", format, &input).unwrap();
        let output2 = parse_xeta2_model_output("new content\n", format, &input).unwrap();
    ...
    fn test_parsed_output_to_patch_round_trips_through_udiff_application() {
        ...
        let parsed = parse_xeta2_model_output(
            "editable new\n>>>>>>> UPDATED\n",
            XetaFormat::V0131GitMergeMarkersPrefix,
            &input,
        )
    ...
    fn test_special_tokens_not_triggered_by_comment_separator() {
        ...
        assert!(
            !prompt_input_contains_special_tokens(&input, XetaFormat::V0131GitMergeMarkersPrefix),
