...
const XENOMORPHIC_INSPECTOR_STYLE_JSON: &str = util_macros::path!("/xenomorphic-inspector-style.json");
        ...
        cx.spawn_in(window, {
            ...
            async move |this, cx| {
                ...
                let json_style_buffer =
                    Self::create_buffer_in_project(XENOMORPHIC_INSPECTOR_STYLE_JSON, &project, cx).await;
