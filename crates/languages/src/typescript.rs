        ...
        pretty_assertions::assert_eq!(
            ...
            [
                (
                    ...
                    Some("${XENOMORPHIC_CUSTOM_TYPESCRIPT_VITEST_PACKAGE_PATH".into()),
                ),
                (
                    "vitest test ${XENOMORPHIC_SYMBOL".into(),
                    Some("${XENOMORPHIC_CUSTOM_TYPESCRIPT_VITEST_PACKAGE_PATH".into()),
                ),
                (
                    "mocha file test".into(),
                    Some("${XENOMORPHIC_CUSTOM_TYPESCRIPT_MOCHA_PACKAGE_PATH".into()),
                ),
                (
                    "mocha test ${XENOMORPHIC_SYMBOL".into(),
                    Some("${XENOMORPHIC_CUSTOM_TYPESCRIPT_MOCHA_PACKAGE_PATH".into()),
                ),
                (
