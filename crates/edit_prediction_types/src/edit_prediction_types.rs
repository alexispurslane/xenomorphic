...
impl EditPredictionIconSet {
    pub fn new(base: IconName) -> Self {
        Self {
            base,
            disabled: IconName::XenomorphicPredictDisabled,
            up: IconName::XenomorphicPredictUp,
            down: IconName::XenomorphicPredictDown,
            error: IconName::XenomorphicPredictError,
        }
    }
