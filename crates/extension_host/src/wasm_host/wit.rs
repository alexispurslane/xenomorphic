...
use task::{DebugScenario, SpawnInTerminal, TaskTemplate, XenomorphicDebugConfig};
...
pub use latest::{
    ...
    xenomorphic::extension::lsp::{
        Completion, CompletionKind, CompletionLabelDetails, InsertTextFormat, Symbol, SymbolKind,
    },
    xenomorphic::extension::slash_command::{SlashCommandArgumentCompletion, SlashCommandOutput},
};
...
pub fn authorize_access_to_unreleased_wasm_api_version(
    ...
    anyhow::ensure!(
        ...
        "unreleased versions of the extension API can only be used on development builds of Xenomorphic"
    );
