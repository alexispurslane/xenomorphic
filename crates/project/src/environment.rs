...
impl ProjectEnvironment {
    ...
    /// Returns the inherited CLI environment, if this project was opened from the Xenomorphic CLI.
...
fn set_origin_marker(env: &mut HashMap<String, String>, origin: EnvironmentOrigin) {
    env.insert(XENOMORPHIC_ENVIRONMENT_ORIGIN_MARKER.to_string(), origin.into());
}

const XENOMORPHIC_ENVIRONMENT_ORIGIN_MARKER: &str = "ZED_ENVIRONMENT";
