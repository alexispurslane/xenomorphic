    ...
    fn security_section() -> [SettingsPageItem; 2] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "When opening Xenomorphic, avoid Restricted Mode by auto-trusting all projects, enabling use of all features without having to give permission to each new project.",
                field: Box::new(SettingField {
    ...
    fn workspace_restoration_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "What to restore from the previous session when opening Xenomorphic.",
                field: Box::new(SettingField {
    ...
    fn scoped_settings_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Which settings should be activated only in Preview build of Xenomorphic.",
                field: Box::new(
                    SettingField {
    ...
    fn privacy_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Send anonymized usage data like what languages you're using Xenomorphic with.",
                field: Box::new(SettingField {
        ...
        [
            ...
            SettingsPageItem::DynamicItem(DynamicItem {
                discriminant: SettingItem {
                    files: USER,
                    title: "Icon Theme",
                    description: "The custom set of icons Xenomorphic will associate with files and directories.",
                    field: Box::new(SettingField {
                ...
                on_click: Arc::new(|settings_window, window, cx| {
                    ...
                    original_window
                        .update(cx, |_workspace, original_window, cx| {
                            original_window
                                .dispatch_action(xenomorphic_actions::OpenKeymap.boxed_clone(), cx);
    ...
    fn file_scan_section() -> [SettingsPageItem; 5] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Files or globs of files that will be excluded by Xenomorphic entirely. They will be skipped during file scans, file searches, and not be displayed in the project file tree. Takes precedence over \"File Scan Inclusions\"",
                field: Box::new(
                    SettingField {
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Files or globs of files that will be included by Xenomorphic, even when ignored by git. This is useful for files that are not tracked by git, but are still important to your project. Note that globs that are overly broad can slow down Xenomorphic's file scanning. \"File Scan Exclusions\" takes precedence over these inclusions",
                field: Box::new(
                    SettingField {
    ...
    fn window_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "(Linux only) whether Xenomorphic or your compositor should draw window decorations.",
                field: Box::new(SettingField {
    ...
    fn general_section() -> [SettingsPageItem; 6] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Whether breakpoints should be reused across Xenomorphic sessions.",
                field: Box::new(SettingField {
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Whether to log messages between active debug adapters and Xenomorphic.",
                field: Box::new(SettingField {
        ...
        [
            ...
            SettingsPageItem::DynamicItem(DynamicItem {
                discriminant: SettingItem {
                    ...
                    description: "Disable all Git integration features in Xenomorphic.",
                    field: Box::new(SettingField::<bool> {
...
fn ai_page(cx: &App) -> SettingsPage {
    fn general_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Disable AI",
                description: "Whether to disable all AI features in Xenomorphic.",
                field: Box::new(SettingField {
...
fn network_page() -> SettingsPage {
    fn network_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Server URL",
                description: "The URL of the Xenomorphic server to connect to.",
                field: Box::new(SettingField {
                ...
                metadata: Some(Box::new(SettingsFieldMetadata {
                    placeholder: Some("https://xenomorphic.dev"),
                    ..Default::default()
                })),
                files: USER,
            }),
...
fn language_settings_data() -> Box<[SettingsPageItem]> {
    ...
    fn autoclose_section() -> [SettingsPageItem; 5] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Use Autoclose",
                description: "Whether to automatically type closing characters for you. For example, when you type '(', Xenomorphic will automatically add a closing ')' at the correct position.",
                field: Box::new(SettingField {
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Whether to automatically surround text with characters for you. For example, when you select text and type '(', Xenomorphic will automatically surround text with ().",
                field: Box::new(SettingField {
    ...
    fn tasks_section() -> [SettingsPageItem; 4] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Prefer LSP",
                description: "Use LSP tasks over Xenomorphic language extension tasks.",
                field: Box::new(SettingField {
...
fn edit_prediction_language_settings_section() -> [SettingsPageItem; 5] {
    [
        ...
        SettingsPageItem::SubPageLink(SubPageLink {
            ...
            description: Some("Set up different edit prediction providers in complement to Xenomorphic's built-in Xeta model.".into()),
            in_json: false,
            files: USER,
        ...
        SettingsPageItem::SettingItem(SettingItem {
            ...
            description: "Controls whether Xenomorphic may collect training data when using Xenomorphic's Edit Predictions. Data is only collected for files in projects detected as open source. The default value uses the preference previously set via the status-bar toggle, or false if no preference has been stored.",
            field: Box::new(SettingField {
